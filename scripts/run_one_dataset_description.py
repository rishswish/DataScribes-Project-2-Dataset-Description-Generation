...
def main():
    ...
    parser.add_argument("--input_csv", required=True, help="Path to sampled CSV file")
    parser.add_argument("--output_json", required=True, help="Path to save prompt + description")
