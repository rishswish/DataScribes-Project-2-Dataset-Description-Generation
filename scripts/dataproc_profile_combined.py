...
def main():
    ...
    input_path = "hdfs:///user/km6579_nyu_edu/data/metadata/combined_metadata_with_samples_v2.parquet"
    output_path = "hdfs:///user/km6579_nyu_edu/data/profiles/combined_profiles_spark_v2.parquet"
